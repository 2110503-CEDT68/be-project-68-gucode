...
exports.getDentists = async (req, res, next) =>{
    ...
    // Finding Resource
    query = Dentist.find(JSON.parse(queryStr)).populate('Bookings'); // Unexecute yet
...
// @desc        Get single dentist data from input ID
